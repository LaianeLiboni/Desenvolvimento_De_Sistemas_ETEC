...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-displaymiddle">
    <h1 class="w3-center w3-teal w3-round-large w3-margin">Cadastro de Jogos</h1>
    <form action="cadastroAction2.php" class="w3-container" method='post'>
        ...
        <label class="w3-text-teal" style="fontweight: bold;">Fabricante</label>
        <input name="txtFabricante" class="w3-input w3-light-grey w3-border"><br>
