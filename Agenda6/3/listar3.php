...
<head>
	...
	<title>Listagem de Alunos Concluintes - MYSQLI</title>
</head>
<body>
<a href="index3.php" class="w3-display-topleft">
    <i class="fa fa-arrow-circle-left w3-large w3-blue w3-button w3-xxlarge"></i>     
        ...
        <?php
            ...
            if ($conexao->connect_error) {
                ...
                <h1 class="w3-center w3-blue w3-round-large w3-margin">Listagem de Alunos Concluintes</h1>
